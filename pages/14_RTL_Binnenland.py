...
st.set_page_config(page_title="RTL Binnenland", page_icon="🇳🇱", layout="wide")
st.markdown("# RTL Binnenland")
...
render_section("RTL Binnenland", hours_limit=hours, query=query, max_items=200, thumbs_n=6)
