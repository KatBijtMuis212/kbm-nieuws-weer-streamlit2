...
st.set_page_config(page_title="Sport • KbM Nieuws", page_icon="🗞️", layout="wide")
inject_css(st)
...
st.title("Sport")
st.caption("Sport & Formule 1 (selectie).")
...
items, _ = collect_items(CATEGORY_FEEDS.get("Sport", []), query=query or None, max_per_feed=60, force_fetch=force_fetch)
