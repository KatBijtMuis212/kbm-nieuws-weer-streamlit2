...
st.set_page_config(page_title="Tech • KbM Nieuws", page_icon="🗞️", layout="wide")
inject_css(st)
...
st.title("Tech")
st.caption("Tech / wetenschap / slimmer leven (selectie).")
...
items, _ = collect_items(CATEGORY_FEEDS.get("Tech", []), query=query or None, max_per_feed=60, force_fetch=force_fetch)
