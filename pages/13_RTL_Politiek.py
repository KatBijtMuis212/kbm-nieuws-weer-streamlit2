...
st.set_page_config(page_title="RTL Politiek", page_icon="🏛️", layout="wide")
st.markdown("# RTL Politiek")
...
render_section("RTL Politiek", hours_limit=hours, query=query, max_items=200, thumbs_n=6)
