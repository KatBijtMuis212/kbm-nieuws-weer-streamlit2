...
st.set_page_config(page_title="RTL Economie", page_icon="💶", layout="wide")
st.markdown("# RTL Economie")
...
render_section("RTL Economie", hours_limit=hours, query=query, max_items=200, thumbs_n=6)
