...
st.set_page_config(page_title="Lokaal • KbM Nieuws", page_icon="🗞️", layout="wide")
inject_css(st)
...
st.title("Lokaal")
st.caption("RTV Midden Holland (lokaal).")
...
items, _ = collect_items(CATEGORY_FEEDS.get("Lokaal", []), query=query or None, max_per_feed=60, force_fetch=force_fetch)
