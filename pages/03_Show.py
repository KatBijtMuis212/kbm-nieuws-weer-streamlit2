...
st.set_page_config(page_title="Show • KbM Nieuws", page_icon="🗞️", layout="wide")
inject_css(st)
...
st.title("Show")
st.caption("Entertainment / cultuur / sterren (selectie).")
...
items, _ = collect_items(CATEGORY_FEEDS.get("Show", []), query=query or None, max_per_feed=60, force_fetch=force_fetch)
