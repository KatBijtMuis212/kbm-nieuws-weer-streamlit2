...
st.set_page_config(page_title="Opmerkelijk • KbM Nieuws", page_icon="🗞️", layout="wide")
inject_css(st)
...
st.title("Opmerkelijk")
st.caption("Opmerkelijk + goed nieuws (selectie).")
...
items, _ = collect_items(CATEGORY_FEEDS.get("Opmerkelijk", []), query=query or None, max_per_feed=60, force_fetch=force_fetch)
