...
st.set_page_config(page_title="Opmerkelijk", page_icon="🗞️", layout="wide")
st.markdown("# Opmerkelijk")
...
render_section("Opmerkelijk", hours_limit=hours, query=query, max_items=200, thumbs_n=8)
