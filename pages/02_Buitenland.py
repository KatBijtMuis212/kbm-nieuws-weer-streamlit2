...
st.set_page_config(page_title="Buitenland • KbM Nieuws", page_icon="🗞️", layout="wide")
inject_css(st)
...
st.title("Buitenland")
st.caption("Buitenland nieuws (selectie).")
...
items, _ = collect_items(CATEGORY_FEEDS.get("Buitenland", []), query=query or None, max_per_feed=60, force_fetch=force_fetch)
