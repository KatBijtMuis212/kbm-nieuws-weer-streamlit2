...
st.set_page_config(page_title="RTL Boulevard", page_icon="✨", layout="wide")
st.markdown("# RTL Boulevard")
...
render_section("RTL Boulevard", hours_limit=hours, query=query, max_items=200, thumbs_n=6)
