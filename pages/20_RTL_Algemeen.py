...
st.set_page_config(page_title="RTL Algemeen", page_icon="📺", layout="wide")
st.markdown("# RTL Algemeen")
...
render_section("RTL Algemeen", hours_limit=hours, query=query, max_items=200, thumbs_n=6)
