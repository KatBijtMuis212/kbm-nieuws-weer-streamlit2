...
st.set_page_config(page_title="RTL Nieuws", page_icon="📺", layout="wide")
st.markdown("# RTL Nieuws")
...
render_section("RTL Nieuws", hours_limit=hours, query=query, max_items=200, thumbs_n=6)
